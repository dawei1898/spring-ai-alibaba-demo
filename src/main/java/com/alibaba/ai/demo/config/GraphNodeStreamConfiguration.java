...
import com.alibaba.ai.demo.model.AsyncExpanderNode;
import com.alibaba.ai.demo.model.ExpanderNode;
...
public class GraphNodeStreamConfiguration {
    ...
    public StateGraph streamGraph(ChatClient.Builder chatClientBuilder) throws GraphStateException {
        ...
        StateGraph stateGraph = new StateGraph(keyStrategyFactory)
                ...
                .addNode("expander", node_async(new AsyncExpanderNode(chatClientBuilder)))
